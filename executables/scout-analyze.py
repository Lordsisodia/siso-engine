...
# Get default project path from resolver
_resolver = get_path_resolver()
DEFAULT_PROJECT_PATH = str(_resolver.get_project_path())
from pathlib import Path
...
class ImprovementScout:
    ...
    def analyze_skill_metrics(self) -> None:
        ...
        metrics_file = self.project_dir / "operations" / "skill-registry.yaml"
        ...
        try:
            ...
            for skill_name, skill_data in skills_iter:
                ...
                if effectiveness is not None and effectiveness < 70:
                    self.opportunities.append(Opportunity(
                        ...
                        evidence=f"skill-registry.yaml: effectiveness_score={effectiveness}",
                ...
                if usage_count == 0:
                    self.opportunities.append(Opportunity(
                        ...
                        evidence=f"skill-registry.yaml: usage_count=0",
                        impact_score=2,
                        effort_score=2,
                        frequency_score=1,
                ...
                if trigger_accuracy is not None and trigger_accuracy < 80:
                    self.opportunities.append(Opportunity(
                        ...
                        evidence=f"skill-registry.yaml: trigger_accuracy={trigger_accuracy}",
                        impact_score=3,
                        effort_score=2,
                        frequency_score=3,
            ...
            if null_skills_count >= 10:
                self.opportunities.append(Opportunity(
                    ...
                    evidence=f"skill-registry.yaml shows {null_skills_count} skills with null values",
                    impact_score=4,
                    effort_score=3,
                    frequency_score=3,
