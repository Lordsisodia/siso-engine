# Agent Creation Architect Prompt
...
NOTE: Ensure in the examples, the assistant uses the Agent tool and not simply respond directly to the task.
...
This is the exact pattern for creating RALF specialist agents:
- JSON output format with identifier, whenToUse, systemPrompt
